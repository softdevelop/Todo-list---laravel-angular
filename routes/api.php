...
Route::post('add-name', 'CreatePostController@create');
Route::get('get-list', 'CreatePostController@list');
Route::get('delete-name/{id}', 'CreatePostController@delete_name');
Route::get('checked-item/{id}', 'CreatePostController@checked');
